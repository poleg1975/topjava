...
public class MealsUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getFilteredWithExceededInOnePass(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), CALORIES_PER_DAY));
        System.out.println(getFilteredWithExceededInOnePass2(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), CALORIES_PER_DAY));
    }
