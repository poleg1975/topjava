    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${users}" var="user">
                ...
                <tr <c:if test="${!user.enabled}">style="background-color: red;"</c:if>>
                    <td><c:out value="${user.name}"/></td>
                    <td><a href="mailto:${user.email}">${user.email}</a></td>
                    <td>${user.roles}</td>
                    <td><input type="checkbox" <c:if test="${user.enabled}">checked</c:if> id="${user.id}" onclick="userStatus(${user.id}, ${user.enabled})"/></td>
